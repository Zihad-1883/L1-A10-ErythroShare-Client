    ...
    return (
        <div className="flex min-h-screen bg-[#080202] text-neutral-100 p-2 md:p-4 relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 pointer-events-none z-0">
                <div className="absolute top-[-10%] left-[30%] w-[600px] h-[600px] rounded-full bg-red-950/20 blur-[130px]" />
                <div className="absolute bottom-[-10%] right-[0%] w-[550px] h-[550px] rounded-full bg-red-900/10 blur-[110px]" />
            </div>
